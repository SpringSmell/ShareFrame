...
import com.future.sharelibrary.adapter.PhotoWallAdapter;
import com.future.sharelibrary.frame.ExitApplication;
import com.future.sharelibrary.function.CameraManager;
 ...
 */
public class PhotoWallActivity extends ShareActivity implements AdapterView.OnItemClickListener {
    ...
    public void onInitLayout() {
        super.onInitLayout();
        setBackValid(getString(R.string.main_confirm), new View.OnClickListener() {
            @Override
    ...
    private void setComplete(int selectCount) {
        ...
        if (maxCount == 0) {
            text = getString(R.string.main_confirm);
        } else {
            text = String.format(getString(R.string.main_confirm) + "(%d/%d)", selectCount, maxCount);
        }
...
//        }
    ...
    private void getCameraImg() {
        ...
        CameraManager.getInstance().goCamera(this, savePath);
    }

    @Override
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == CameraManager.CAMERA_CODE) {
