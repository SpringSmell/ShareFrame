...
import com.future.sharelibrary.tools.TextUtil;
import com.future.sharelibrary.widgets.RollView;
...
public class TimeSelector {
    ...
    public TimeSelector(Context context, ResultHandler resultHandler, String startDate, String endDate) {
        ...
        startCalendar.setTime(FormatUtils.getInstance().getFormatDateStr(startDate, FORMAT_STR));
        endCalendar.setTime(FormatUtils.getInstance().getFormatDateStr(endDate, FORMAT_STR));
    ...
    private void initView() {
        ...
        tv_select.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {String date=FormatUtils.getInstance().getFormatDate(selectedCalender.getTime(), FORMAT_STR);
                if(mode!=null){
                    switch (mode.value){
                        case 1:
                            date=FormatUtils.getInstance().getFormatDate(selectedCalender.getTime(), "yyyy-MM-dd");
                            break;
                        case 2:
                            break;
                    }
    ...
    private void loadComponent() {
        ...
        month_pv.setSelected(selectedCalender.get(Calendar.MONTH)>9?selectedCalender.get(Calendar.MONTH)+"":"0"+(selectedCalender.get(Calendar.MONTH)+1));
        day_pv.setSelected(selectedCalender.get(Calendar.DAY_OF_MONTH)>9?selectedCalender.get(Calendar.DAY_OF_MONTH)+"":"0"+selectedCalender.get(Calendar.DAY_OF_MONTH));
        hour_pv.setSelected(selectedCalender.get(Calendar.HOUR_OF_DAY)>9?selectedCalender.get(Calendar.HOUR_OF_DAY)+"":"0"+selectedCalender.get(Calendar.HOUR_OF_DAY));
        minute_pv.setSelected(selectedCalender.get(Calendar.MINUTE)>9?selectedCalender.get(Calendar.MINUTE)+"":"0"+selectedCalender.get(Calendar.MINUTE));
        excuteScroll();
    }
    ...
    public void setSelectDate(String dateStr) {
        selectedCalender.setTime(FormatUtils.getInstance().getFormatDateStr(dateStr, FORMAT_STR));
    }
