...
public class BaseParentViewHolder {
    ...
    public BaseParentViewHolder setImgRes(int id, int iconId) {
        return setImg(id, "",iconId, null);
    }

    public BaseParentViewHolder setImgRes(int id, int iconId, View.OnClickListener onClickListener) {
        return setImg(id,"",iconId,onClickListener);
    }

    public BaseParentViewHolder setImgUrl(int id, CharSequence url) {
        return setImg(id, url,0, null);
    }

    public BaseParentViewHolder setImgUrl(int id, CharSequence url, View.OnClickListener onClickListener) {
    ...
    private BaseParentViewHolder setImg(int id, CharSequence url, int iconId, View.OnClickListener onClickListener) {
