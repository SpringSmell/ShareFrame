...
//    public void setResolveRecyclerView(RecyclerView recyclerView){
    ...
    public boolean canChildScrollUp() {
        switch (type) {
            ...
            case 2://ScrollView
                ...
                break;
            case 3:
//                if(mRecyclerView!=null&&mRecyclerView.getVisibility()==VISIBLE){
//                    return mRecyclerView.getChildCount()>0&&mRecyclerView.getScrollY()>0;
//                }
                break;
        }
